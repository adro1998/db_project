    ...
    <body>
        <div class="titulo">
            ...
            <div class="scrollmenu">
                    <a href="/db-project/empresa_distribuidora/gestionar-empresa.php">Inicio Gestion</a>
                    <a href="/db-project/empresa_distribuidora/FORMS/registrar-empresa-form.html">Registrar empresa</a>
        ...
        <div align = "center">
            <div>
                <br>
                <form method="POST" action="/db-project/empresa_distribuidora/CRUD/eliminar-empresa-id.php">
                    <table>
